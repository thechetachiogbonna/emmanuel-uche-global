...
import { deleteCollectionAction } from "@/lib/actions/admin-collections";
...
export default function DeleteCollectionButton({
  ...
  const handleDelete = () => {
    startTransition(async () => {
      await deleteCollectionAction(slug);
      setOpen(false);
      router.refresh();
    });
  };
        ...
        >
          ...
          >
            ...
            <p className="text-[13px] text-ink-soft mb-6">
              This removes the collection and all {productCount} of its
